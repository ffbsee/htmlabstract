...
class syntax_plugin_htmlabstract extends DokuWiki_Syntax_Plugin
{
    ...
    function getInfo()
    {
        return array(
            ...
            'date'   => '2017-02-02', //First 2017-01-07,//
            'name'   => 'HtmlAbstract',
            'desc'   => 'Moddified for FFBSee -> DO NOT UPDATE without talking to "L3D" at irc.hackint.org -> "#ffbsee"; Usually Allows integration of remote or local DW RSS feeds using html formatted abstracts instead of choosing between html OR abstract.',
